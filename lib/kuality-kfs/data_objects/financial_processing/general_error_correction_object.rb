class GeneralErrorCorrectionObject < FinancialProcessingObject

  DOC_INFO = { label: 'General Error Correction Document', type_code: 'GEC' }
...
#      page.modify_asset
  ...
  def view
    @browser.goto "#{$base_url}financialGeneralErrorCorrection.do?methodToCall=docHandler&docId=#{@document_id}&command=displayDocSearchView"
