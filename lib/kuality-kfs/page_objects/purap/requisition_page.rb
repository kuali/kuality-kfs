...
#TODO different type/state selection has different manufacturer/model_number tag name
  element(:manufacturer) { |b| b.frm.text_field(name: 'document.purchasingCapitalAssetItems[0].purchasingCapitalAssetSystem.capitalAssetManufacturerName') }
  element(:model_number) { |b| b.frm.text_field(name: 'document.purchasingCapitalAssetItems[0].purchasingCapitalAssetSystem.capitalAssetModelDescription') }
