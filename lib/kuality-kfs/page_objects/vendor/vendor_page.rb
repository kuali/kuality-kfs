class VendorPage < KFSBasePage
  ...
  element(:added_address_1) { |b| b.frm.text_field(name: 'document.newMaintainableObject.vendorAddresses[0].vendorLine1Address') }
  element(:added_phone_type) { |b| b.frm.select(name: 'document.newMaintainableObject.vendorPhoneNumbers[0].vendorPhoneTypeCode') }
  element(:added_address_2) { |b| b.frm.text_field(name: 'document.newMaintainableObject.vendorAddresses[0].vendorLine2Address') }
  element(:added_phone_number) { |b| b.frm.text_field(name: 'document.newMaintainableObject.vendorPhoneNumbers[0].vendorPhoneNumber') }
  element(:added_attention) { |b| b.frm.text_field(name: 'document.newMaintainableObject.vendorAddresses[0].vendorAttentionName') }
  element(:added_phone_ext) { |b| b.frm.text_field(name: 'document.newMaintainableObject.vendorPhoneNumbers[0].vendorPhoneExtensionNumber') }
