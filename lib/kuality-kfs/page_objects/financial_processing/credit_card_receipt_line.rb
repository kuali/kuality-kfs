class CreditCardReceiptLine < FinancialProcessingPage
  ...
  element(:reference_number) { |b| b.frm.text_field(id: 'newCreditCardReceipt.creditCardDepositReferenceNumber') }
  ...
  action(:update_reference_number) { |i, b| b.frm.text_field(id: "document.creditCardReceipt[#{i}].creditCardDepositReferenceNumber") }
